...
//     {name: "eee", genre:'Sci-fi', id:'5', authorId:"3"},
...
// var authors = [
//     {name:"aaaAuthor", age:44, id:"1"},
//     {name:"bbbAuthor", age:42, id:"2"},
//     {name:"cccAuthor", age:66, id:"3"},
    ...
    fields:{
        addAuthor:{
            ...
            resolve(parent, args){
                ...
                console.log("aa");  
                // author.save() for saving in data    
                return author.save();
            }
        },
        addBook:{
